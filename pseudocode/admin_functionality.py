# Admin Functionality Module Pseudocode
# This module handles admin-specific functionality

"""
TDD Test Cases:
- test_create_system_prompt: Verify an admin can create a system prompt
- test_update_system_prompt: Verify an admin can update a system prompt
- test_delete_system_prompt: Verify an admin can delete a system prompt
- test_list_system_prompts: Verify system prompts can be listed
- test_get_system_prompt: Verify a system prompt can be retrieved
- test_set_default_prompt: Verify an admin can set a default prompt
- test_list_users: Verify an admin can list users
- test_update_user_role: Verify an admin can update a user's role
- test_disable_user: Verify an admin can disable a user account
- test_get_conversation_metrics: Verify conversation metrics can be retrieved
"""
...
# Factory function to create admin service
